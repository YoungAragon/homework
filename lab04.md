...
# 颜色到图片
上文提到过图片实质上是颜色的组合，那为何有的图片十分清晰，有的图片却有点模糊呢？这让我们回想一下，我们在相机或者手机广告中常常会听到多少万像素来描述他们产品的拍摄效果。多少像素实质上是描述了图片由多少个像素点来显示，以下是一些常见的像素及其对应的分辨率：
* 30万 640×480
* 50万 800×600
...
我们常识上知道，像素越高、分辨率越高，显示的图片就越清晰。这是因为分辨率高了，参与颜色显示的像素点多了，所以色块的衔接就显得越发最自然流畅。想必大家都知道马赛克，低像素的图片效果就和马赛克效果类似，这里就不做展示了。

---

# 小结
现在，你应该大概认识到图片在计算机里是如何表达的。但是图片在计算机中存在多种存储格式，例如常见的jpg、bmp等等，这些图片类型有什么区别呢？还有图片如何进行压缩呢？我希望能通过后续学习再来解答这些问题，以飨读者。
